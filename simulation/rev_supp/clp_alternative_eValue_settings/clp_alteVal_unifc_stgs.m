    ...
    parfor m = 1:m_deRand
        ...
        for i0 = row_indices'
            ...
            for ii = 1:r2
                ...
                % alternative method for e-values
                evalues_inaTestsplit = 1 ./ ( 2 * (sqrt(1.001) - sqrt(0.001)) .* sqrt(pvalues_inaTestsplit + 0.001) );
...
% Save results
save(['clp_alteVal_unic_stg' num2str(graphon_setting) '.mat'], 'res_example');
% loaded_data = load('clp_unic_stg1.mat');
