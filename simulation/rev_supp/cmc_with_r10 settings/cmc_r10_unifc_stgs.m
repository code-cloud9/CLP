...
parfor rep_idx = 1:reps
    ...
    mask_eg = (~eye(node_num)) & (matrix_M_eg ~= 1);
    matrix_C_eg = quantile(matrix_A_eg(mask_eg), sig(idx_sig)) * ones(node_num,node_num);
...
% Save results
save(['cmc_r10_unic_stg' num2str(graphon_setting) '.mat'], 'res_example');
