...
for rep_idx = 1:reps
    ...
    [matrix_A_eg, matrix_M_eg, matrix_C_eg] = gen_data(graphon_setting, node_num, sig(idx_sig), missing_prob);  
...
% Save results
save(['clp_signal_stg' num2str(graphon_setting) '.mat'], 'res_example');
