...
alpha_2 = 0.2; 
sig = 1.5:0.05:2.0; % signal strength
...
parfor rep_idx = 1:reps
    ...
    [matrix_A_eg, matrix_M_eg, matrix_C_eg] = gen_data(graphon_setting, node_num, 1, missing_prob);  
...
% Save results
save(['cmc_signal_stg' num2str(graphon_setting) '.mat'], 'res_example');
