...
parfor rep_idx = 1:reps
    ...
    for idx_sig = 1:nsig
        ...
        [matrix_A_eg, matrix_M_eg, matrix_C_eg] = gen_data(graphon_setting, node_num, 1, missing_prob,1,isBinary,isHetero);
        
        matrix_Alt = ((matrix_M_eg).*matrix_A_eg - (matrix_M_eg).*matrix_C_eg)>0;
        ...
        matrix_C_eg = matrix_M_eg.*matrix_A_eg - sig(idx_sig).*matrix_Alt;
...
% Save results
save(['dss_binary_stg' num2str(graphon_setting) '.mat'], 'res_example');
